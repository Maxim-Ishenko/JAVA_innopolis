...
import ru.innopolis.utils.CustomExceptions.UserNotFoundException;
import ru.innopolis.utils.Helpers.FileWorkHelper;
...
import static ru.innopolis.utils.Helpers.DataHandlerParserHelper.setUsersCollectionFromTheFile;
...
public class UsersRepositoryImpl implements UsersRepository {
    ...
    public User findById_forMavenReader(String id, String path) throws IOException {
        try (InputStream inputStream = getClass().getResourceAsStream(path)) {
            ArrayList<User> usersCollection = setUsersCollectionFromTheFile(inputStream);
            User targetUser = usersCollection.stream().filter(user -> Objects.equals(id, user.getId()))
                    .findAny()
                    .orElse(null);
