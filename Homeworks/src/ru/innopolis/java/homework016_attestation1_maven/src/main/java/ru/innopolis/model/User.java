...
public class User {
    ...
    public String toString() {
        String localDateTimeString = localDateTime.format(DateTimeFormatter.ofPattern(UsersRepository.LOCAL_DATE_FORMATTER_PATTERN));

        return id + UsersRepository.USER_PARAMS_DIVIDER +
                localDateTimeString + UsersRepository.USER_PARAMS_DIVIDER +
                login + UsersRepository.USER_PARAMS_DIVIDER +
                password + UsersRepository.USER_PARAMS_DIVIDER +
                confirmPassword + UsersRepository.USER_PARAMS_DIVIDER +
                surname + UsersRepository.USER_PARAMS_DIVIDER +
                name + UsersRepository.USER_PARAMS_DIVIDER +
                patronymic + UsersRepository.USER_PARAMS_DIVIDER +
                age + UsersRepository.USER_PARAMS_DIVIDER +
                isWorker;
    }
    @Override
